...
cara al cliente externo; el acceso al workspace operativo (\texttt{/login}) autentica por rol,
coherente con RNF01 (control de acceso por cargo) y con los tres roles definidos en la Sección 1:
Cliente, Cajero de Agencia y Operario de Bodega.
...
\begin{figure}[h!]
  ...
  \caption{Acceso al sistema --- autenticación por rol (RNF01)}
\end{figure}
...
guías de envío, guías con novedad) y una visualización interactiva de los dos diagramas de estados
parametrizados (\texttt{ESTADO\_TIQUETE} y \texttt{ESTADO\_GUIA}), antes de mostrar las tablas de
roles ya vistas en la Sección 2.
